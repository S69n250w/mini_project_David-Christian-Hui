...
class TransactionPage extends StatefulWidget {
  ...
  const TransactionPage({Key? key, required this.transactionsWithCategory}) : super(key: key);
...
class _TransactionPageState extends State<TransactionPage> {
  ...
  Future insert(String description, int categoryId, int amount, DateTime date) async {
  ...
  void updateTransaction(TransactionWithCategory initTransaction) {
    ...
    descriptionController.text = initTransaction.transaction.description.toString();
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (snapshot.hasData) {
                        ...
                        return Text("There are no categories yet");
                      }
                    }
                  },
                ),
                  ...
                  child: TextFormField(
                    ...
                    onTap: () async {
                      ...
                      if (pickedDate != null) {
                        ...
                        String formattedDate = DateFormat('yyyy-MM-dd').format(pickedDate); // format date in required form here we use yyyy-MM-dd thst means time is removed
